...
from reconcile.utils import aws_api as awsapi
...
def build_desired_state_vpc_mesh(clusters, ocm_map: OCMMap, aws_api: AWSApi):
    """
...
def build_desired_state_vpc(clusters, ocm_map: OCMMap, aws_api: AWSApi):
    """
